      ...
      <div class="qv-body">
        ...
        <div class="qv-info">
          ...
          <div class="qv-actions">
            ...
            <button class="qv-btn-more" onclick="closeQuickView();var _base=location.pathname.includes('/pages/')?'../products/':'products/';window.location.href=_base+'producto-${slug}.html'">Ver más →</button>
          </div>
        </div>
      </div>
    `;
